...
export enum ImageName {
  ...
  bitcoin = 'bitcoin',
  caseDataSqlResolved = 'caseDataSqlResolved',
  ...
  siteCaseDataUnresolved = 'siteCaseDataUnresolved',
  sitesCaseDataQuery = 'sitesCaseDataQuery',
  sitesSqlResolved = 'sitesSqlResolved',
...
export const images: ImageMetaData = {
  ...
  [ImageName.caseDataSqlResolved]: new Image({
    altText: 'Case Data Resolved SQL Queries',
    height: 362,
    url: blogImage('queries/casedata-sql-resolved.png'),
    width: 1147,
  }),
  ...
  [ImageName.siteCaseDataUnresolved]: new Image({
    altText: 'Unresolved site, case data.',
    height: 377,
    url: blogImage('queries/site-casedata-unresolved.png'),
    width: 1028,
  }),
  [ImageName.sitesCaseDataQuery]: new Image({
    altText: 'Query for sites and caseData',
    height: 172,
    url: blogImage('queries/sites-casedata-query.png'),
    width: 221,
  }),
  [ImageName.sitesSqlResolved]: new Image({
    altText: 'Results of sql after using resolved function.',
    height: 524,
    url: blogImage('queries/sites-sql-resolved.png'),
    width: 1156,
  }),
