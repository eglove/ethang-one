  ...
  return (
    <StaticBlogLayout blog={blog}>
      ...
      <p>
        ...
        through this course, if you want to commit to it, you can{' '}
        <NextLink
      ...
      <h2>Courses Added</h2>
      <p>
        <strong>CompTIA A+ Core 1 & 2</strong>: This is a course built for
      ...
      <p>
        ...
        often, and when it is, not very well covered. When you get into Next.js
        you will find very lackluster explanations of &ldquo;SEO&rdquo; that
        center around static generation and title tags. SEO is more than that.
        And every web dev should have an understanding of schema markup, link
        building and site structure. This course will cover all of those and
        more in a great detail.
      </p>
      <p>
        ...
        interpretation of it. But learning these things officially from the
        Agile Manifesto can really help you make better decisions if you find
        yourself in a SCRUM master or product owner role.
      </p>
      ...
      <p>
        ...
        grows, this course has simply been replaced. Each particular topic is
        covered the basics on, you will either find entire coruses, or more in
        depth explorations of in other courses here.
      </p>
      <p>
        ...
        appropriate subject for this course list.
      </p>
    </StaticBlogLayout>
  );
}
