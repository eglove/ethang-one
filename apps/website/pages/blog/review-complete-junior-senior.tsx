...
function ReviewCompleteJuniorSenior(): JSX.Element {
  return (
    <StaticBlogLayout blog={blogs.reviewCompleteJuniorSenior}>
      <p>
        ...
        video saying, &ldquo;You might still see React classes in the wild, but
        we&apos;ll still use them here.&rdquo; Then tacked on hooks as an
        appendix item.
      </p>
      <p>
        ...
        &ldquo;2022&rdquo; update) to have students convert that functional
        component that React defaults to into a class component. He then spends
        some time ranting against hooks. Again, throwing out every argument he
        can think of, except the truth. He says other languages use classes, so
        students should learn them here. This is ridiculous, React is not a good
        place to learn object-oriented programming. Maybe typescript or node,
        but the comparison between React classes and a traditional class is a
        bit of a stretch. He also says students should learn about classes
        because it was the way things used to be done. That&apos;s absolutely
        fair, I like that, but don&apos;t build the whole project with classes
        only to tack on an update at the end. A third argument he throws out is
        that there is a &ldquo;movement&rdquo; to avoid hooks. There is not.
        Hooks are the standard way to write React apps today.
      </p>
      <p>
      ...
      <p>
        ...
        analysis, Docker, Redis, sessions, JWT, AWS, CDN, caching, GZip,
        CI/CD,&nbsp; and lots of stuff in between. Even if this course
        doesn&apos;t get many updates, these other subjects haven&apos;t changed
        much in the last 5 years.
      </p>
      <p>
      ...
      <p>
        ...
        <strong>PLEASE SKIP THE REACT SECTION</strong>. There are courses that
        teach React properly. This particular course gives a general overview of
        a lot of subjects you should have an awareness of. What it does not
        appropriately cover is React. And you will not learn anything about
        classes by following that section as Andrei argues. That section is the
        result of laziness and nothing more.
      </p>
      <p>
