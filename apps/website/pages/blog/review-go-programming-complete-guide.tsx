    ...
    <StaticBlogLayout slug={blogSlug.reviewGoProgramming}>
      ...
      <span itemScope itemType="https://schema.org/Review">
        ...
        <p>
          ...
          then type it into an editor. Then move on. It&apos;s not only a slow
          and boring way to read docs, but it&apos;s not a useful strategy.
        </p>
        <p>
          For people who learn best by video, this is not helpful. For people
          who learn best by reading text, they&apos;re better off reading the
        ...
        <p>
          ...
          Grider&apos;s TypeScript course, the concepts are still covered in
          code. Always explained in the context of code you might actually
          write.
        </p>
        <p>
        ...
        <p>
          ...
          lifetime membership to Zero To Mastery, I have to start recommending
          to avoid the site altogether. Get the few good courses they have on
