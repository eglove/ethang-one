    ...
    <Container>
      ...
      <article>
        ...
        <p>
          ...
          smallest pieces and learning the individual parts. That helped me to
          use more complex features later down the line.
        </p>
        <p>
          However, that method did not help me to continue to learn new
          languages and concepts. What helped, was systems thinking. I learn by
          finding relationships between things that I&apos;ve learned in the
          past. It helps to think about the larger system. How does anything new
          I come across relate to what I already know?
        </p>
        <p>
          When I code new features, I tend to approach it from the context of
          the entire system. How is this going to interact with the rest of the
          application? What are the possible unintended consequences of
          committing to the first, and simplest solution? Is there design or
          architecture that can ensure the safety, long term stability, and
        ...
        <p>
          I love standardization in languages, and I understand the value of
          them. The most clear example is SQL, standardized under{' '}
          <NextLink
        ...
        <p>
          And of course knowledge of standards is something to layer new
          knowledge on top of as a frame of reference.
        </p>
        <p>
          Putting focus on standardized languages rather than frameworks ensures
          the long term stability of your own marketability. (Frameworks come
          and go.) It also allows you to employ the{' '}
          <NextLink
            linkProperties={{
          ...
          use, and slower in performance than what its trying to abstract. This
          is often due to those foundation languages expanding or updating
          themselves so as to make their replacements unnecessary. (jQuery is
          dead, and so is Axios)
        </p>
        <p>
          ...
          embedding YouTube videos. Even on a page with plain, static HTML such
          as this one.
        </p>
        <p>
          My point is only to remain aware of the most base level, standardized
          languages, their updates, their philosophy, and how to use them.
          Because often, the tools we take for granted are not doing us any
          favors.
        </p>
        <h2 id="stoicism">
        ...
        <p>
          Stoicism can mean different things to different people. What I take
          from it is the idea that I don&apos;t need to react to things that are
          out of my control. Sometimes having an emotional reaction to things
          out of our control can mean validation. If Person A has a lack of
          panic in a serious situation, Person B may think Person A is not
          taking the situation seriously. In fact, I think Person A has the
          correct mindset. Accept the situation, and do what you can. You can
          not control what has already happened.
        </p>
        <p>
        ...
        <p>
          ...
          change, and not worry about what I can&apos;t. Although I can&apos;t
          say I&apos;m perfectly consistent with it.
        </p>
        <h2 id="learning">
        ...
        <p>
          ...
          for any language or framework. &ldquo;I want to use a mixin, how do I
          do that in PHP? Oh, it&apos;s called a Trait.&rdquo;
        </p>
        <p>
          I try to have a broad range of knowledge across a lot of languages and
          frameworks. As evidenced by my{' '}
          <NextLink linkProperties={{ href: '/' }}>home page</NextLink>. If I
          talk about the disadvantage of your personal favorite, I say that in
        ...
        <p>
          Wanting to branch out and learn as much as possible has been a point
          of confusion for others understanding &lsquo;who I am&rsquo;. My
          homepage randomly lists technologies I&apos;ve touched. The randomness
          is very much for a reason. Because I don&apos;t want to be considered
          an X developer, I want to be considered a developer. This is a
          difficult concept for people to get around who have dedicated
          themselves to the expertise of a particular language or particular
          tool.
        </p>
        <p>
          ...
          development&rsquo;. It&apos;s simply a matter of personal preference
          and thinking. Not better than, or worse then, just personal to me.
        </p>
        <p>
          ...
          fixture of this site and who I am. Always a plan to learn something
          new. Always looking to create relationships between what I have
          learned and what I haven&apos;t. Not choosing a favorite to stick to,
